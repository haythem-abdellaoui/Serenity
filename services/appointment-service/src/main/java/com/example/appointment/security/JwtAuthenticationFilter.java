...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final AppointmentJwtValidator appointmentJwtValidator;
    ...
    protected void doFilterInternal(
        ...
        try {
            Claims claims = appointmentJwtValidator.parseAndValidate(jwt);
            ...
            if (StringUtils.hasText(authorizationHeader)) {
                request.setAttribute(AppointmentRequestAttributes.AUTHORIZATION_HEADER, authorizationHeader);
            }
    ...
    private static String extractJwtFromAuthorizationHeader(String bearer) {
